...
<head>
    ...
    <style>
      ...
      background: linear-gradient(to right, #ff004f, #833ab4);
      color: white;
      padding: 10px 20px;
      border-radius: 12px;
      font-size: 18px;
    ...
    .new-widget, .water-tracker, .anime-header, .badge-section {
      margin-top: 30px;
      ...
      border-radius: 5px;
        ...
        .dark-mode {
          ...
          #chatbox {
  position: fixed;
  bottom: 80px; /* adjust this if needed */
  left: 50%;
  ...
  width: 100%;
   justify-content: center;
   align-items: style="text-align: right; margin: 20px;";
}
    #chatbot input {
      width: 100%;
      padding: 8px;
    ...
    <div class="main">
        ...
        <div class="tracker-container">
            <div class="tracker-header row">
                <h3 class="col-9">🔥Track your daily Routine!🌸</h3>
            ...
            <div class="text-center mt-3"style="text-align: right; margin: 20px;">
...
<div id="chatbot">
  <div class="chat-header">
    AI Chatbot
    <span style="float:left; cursor:pointer;" onclick="toggleChat()">✖</span>
  </div>
  <div id="chatlog"></div>
...
<script>
  ...
  function sendMessage() {
    ...
    if (input.value.trim()) {
      chatlog.innerHTML += `<div><b>You:</b> ${input.value}</div>`;
      chatlog.innerHTML += `<div><b>Bot:</b> Thinking...</div>`;

      // Simulated AI reply
      setTimeout(() => {
        chatlog.lastChild.innerHTML = `<b>Bot:</b> I'm just a demo bot 🤖. Still under the development...`;
  ...
  function isToday(dateString) {
    ...
    function generateFocusReport() {
      const habits = JSON.parse(localStorage.getItem('habits')) || [];
      const moodLogs = JSON.parse(localStorage.getItem('moods')) || [];
      const focusSessions = JSON.parse(localStorage.getItem('focus')) || [];

      let completedToday = habits.filter(h => isToday(h.date)).length;
      let moodToday = moodLogs.filter(m => isToday(m.date)).map(m => m.mood);
      let focusTime = focusSessions.reduce((total, session) => total + (session.end - session.start), 0);

      alert(`📝 Focus Report:\n\n✅ Habits Completed Today: ${completedToday}\n🕒 Focus Time: ${Math.round(focusTime / 60000)} minutes\n😊 Mood Today: ${moodToday.join(", ") || 'No entry yet'}`);
    }
    ...
    function downloadFocusReport() {
      ...
      let textContent = `📝 Your Focus Report\n\n`;
      textContent += `✅ Habits Completed Today: ${completedToday}\n`;
      textContent += `🕒 Focus Time: ${Math.round(focusTime / 60000)} minutes\n`;
      textContent += `😊 Mood Today: ${moodToday.join(", ") || 'No entry yet'}\n`;

      const blob = new Blob([textContent], { type: 'text/plain' });
      const link = document.createElement('a');
      link.href = URL.createObjectURL(blob);
      link.download = 'FocusReport.txt';
      link.click();
    }
</script>
            ...
            <!-- 🟡 New Feature 1: Welcome Banner -->
                 <div class="welcome-banner"><marquee scrollamount=20>Welcome back, BUDDY! 🎯 Let's crush your goals today.</marquee></div>

            <!-- Add Modal -->
            <div class="modal fade" id="addTrackerModal" tabindex="-1" aria-labelledby="addTracker" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content" style="background-color: rgb(139, 220, 241)">
                        ...
                        <div class="modal-body">
                            <form action="./endpoint/add-tracker.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="alcohol" class="col-sm-6 col-form-label">Revision:</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="meat" class="col-sm-6 col-form-label">HYDRATED:</label>
                                    <div class="col-sm-6">
            ...
            <div class="modal fade" id="updateTrackerModal" tabindex="-1" aria-labelledby="updateTracker" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content" style="background-color: rgb(239, 83, 221)">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="./endpoint/update-tracker.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="updateAlcohol" class="col-sm-6 col-form-label">Revision:</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="updateMeat" class="col-sm-6 col-form-label">Hydrated:</label>
                                    <div class="col-sm-6">
            ...
            <div class="table-container">
                <table class="table habit-table">
                    ...
                    <tbody>
                        ...
                        <button onclick="generateFocusReport()">📊&nbsp;Show My Focus Report</button>
                        <button onclick="downloadFocusReport()">⬇️&nbsp;Download Report</button>
                        </div>
                        <?php 
